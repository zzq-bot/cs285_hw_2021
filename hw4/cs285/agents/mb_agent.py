...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            #maybe could use shuffle num_data[i*num_..ens, (i+1)...] instead
            observations = ob_no[idxs]# TODO(Q1)
            actions = ac_na[idxs]# TODO(Q1)
            next_observations = next_ob_no[idxs]# TODO(Q1)
